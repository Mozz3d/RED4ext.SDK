...
#pragma region deprecated
    ...
    inline void ConstructCls(ScriptInstance aMemory) const
    {
        OnConstruct(aMemory);
    }

    [[deprecated("Use 'OnDestruct()' instead.")]]
    inline void DestructCls(ScriptInstance aMemory) const
    {
        OnDestruct(aMemory);
    }

    [[deprecated("Use 'CreateObject()' instead.")]]
    inline ScriptInstance CreateInstance(bool aZeroMemory = false) const
    {

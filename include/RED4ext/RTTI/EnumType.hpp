...
struct EnumType : IType
{
    ...
    virtual bool ToString(const ScriptData* aObject, CString& aOut) const final;                           // 68
    virtual bool FromString(ScriptData* aObject, const CString& aString) const final;                      // 70

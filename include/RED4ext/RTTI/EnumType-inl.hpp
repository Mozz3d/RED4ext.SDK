...
RED4EXT_INLINE RED4ext::rtti::ERTTIType RED4ext::rtti::EnumType::GetType() const
{
...
RED4EXT_INLINE void RED4ext::rtti::EnumType::Construct(void* aMemory) const
{
    RED4EXT_UNUSED_PARAMETER(aMemory);
}

RED4EXT_INLINE void RED4ext::rtti::EnumType::Destruct(void* aMemory) const
{
    RED4EXT_UNUSED_PARAMETER(aMemory);
}

RED4EXT_INLINE const bool RED4ext::rtti::EnumType::IsEqual(const void* aLhs, const void* aRhs, uint32_t a3)
{
...
RED4EXT_INLINE void RED4ext::rtti::EnumType::Assign(void* aLhs, const void* aRhs) const
{
    switch (actualSize)
    {
    case 1:
...
RED4EXT_INLINE bool RED4ext::rtti::EnumType::Unserialize(BaseStream* aStream, void* aInstance, int64_t a3) const
{
    using func_t = bool (*)(const EnumType*, BaseStream*, void*, int64_t);
    static UniversalRelocFunc<func_t> func(Detail::AddressHashes::CEnum_Unserialize);
    return func(this, aStream, aInstance, a3);
}

RED4EXT_INLINE bool RED4ext::rtti::EnumType::ToString(const void* aInstance, CString& aOut) const
{
...
RED4EXT_INLINE bool RED4ext::rtti::EnumType::FromString(void* aInstance, const CString& aString) const
{

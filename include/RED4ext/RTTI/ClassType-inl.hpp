...
RED4EXT_INLINE bool RED4ext::rtti::ClassType::WriteValue(int64_t a1, ScriptInstance aInstance, CString& a3, int64_t a4, bool a5)
{
...
RED4EXT_INLINE void RED4ext::rtti::ClassType::InitializeScriptedProperties(ScriptInstance aMemory)
{
    static UniversalRelocFunc<void (*)(ClassType*, ScriptInstance)> func(Detail::AddressHashes::CClass_InitializeProperties);
    func(this, aInstance);
}

RED4EXT_INLINE void RED4ext::rtti::ClassType::InitializeScriptDefaultValues(ScriptInstance aMemory)
{
    static UniversalRelocFunc<void (*)(ClassType*, ScriptInstance)> func(Detail::AddressHashes::CClass_AssignDefaultValuesToProperties);
    func(this, aInstance);
}
...
RED4EXT_INLINE bool RED4ext::rtti::ClassType::DeepCompare(const ScriptInstance aLhs, const ScriptInstance aRhs, uint32_t a3)()
{
